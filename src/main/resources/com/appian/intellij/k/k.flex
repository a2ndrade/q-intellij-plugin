...
INT_VECTOR_ITEM={NUMBER_INTEGER}|{Q_NIL}|{INFINITY}
FLOAT_VECTOR_ITEM={NUMBER_INTEGER}|{NUMBER_FLOAT}|{NUMBER_EXP}|{Q_NIL}|{INFINITY}
TIME_VECTOR_ITEM={NUMBER_INTEGER}|{Q_NIL}|{Q_MINUTE}|{Q_SECOND}|{Q_TIME}|{INFINITY}
MONTH_VECTOR_ITEM={Q_MONTH}|{Q_NIL}|{INFINITY}
DATE_VECTOR_ITEM={Q_DATE}|{Q_NIL}|{INFINITY}
DATETIME_VECTOR_ITEM={Q_DATETIME}|{Q_DATE}|{Q_NIL}|{INFINITY}
TIMESTAMP_VECTOR_ITEM={Q_TIMESTAMP}|{Q_TIMESPAN}|{NUMBER_FLOAT}|{TIME_VECTOR_ITEM}
NUMBER_VECTOR={INT_VECTOR_ITEM}({WHITE_SPACE}{INT_VECTOR_ITEM})+{INT_TYPE}?|
              {FLOAT_VECTOR_ITEM}({WHITE_SPACE}{FLOAT_VECTOR_ITEM})+{FLOAT_TYPE}?|
              {TIMESTAMP_VECTOR_ITEM}({WHITE_SPACE}{TIMESTAMP_VECTOR_ITEM})+{TIMESPAN_STAMP_TYPE}?|
              {TIME_VECTOR_ITEM}({WHITE_SPACE}{TIME_VECTOR_ITEM})+{Q_TIME_TYPE}?|
              {MONTH_VECTOR_ITEM}({WHITE_SPACE}{MONTH_VECTOR_ITEM})+"m"?|
              {DATE_VECTOR_ITEM}({WHITE_SPACE}{DATE_VECTOR_ITEM})+"d"?|
              {DATETIME_VECTOR_ITEM}({WHITE_SPACE}{DATETIME_VECTOR_ITEM})+"z"?|
              {BINARY_VECTOR}
C=([^\\\"]|\\[^\ \t])
CHAR=\"{C}\"
CHAR_VECTOR=\"{C}*\"
